...
# Chip Overview
The MMC5603NJ is an ultra small (0.8 x 0.8 x 0.4 mm!) magnetometer chip that uses I2C interfacing to measure magnetic fields in the form of X, Y, and Z outputs.
